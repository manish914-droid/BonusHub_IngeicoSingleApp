...
//endregion =========================================================================== Diners Live cap keys ends==================================================================================================================================================================================================================================
         ...
         //    val tag8F: TLV = tlvList.getTLV("8F")
           //  val byte8F: ByteArray = tag8F.getBytesValue()
           //  println("=> CAPKEY Index -->  ${BytesUtil.bytes2HexString(byte8F).toString()}")
  ...
  //emv?.setTLV(finalData.kernelID.toInt(),DEF_TAG_M_REQ_NOCVM,"60")//todo change
        ...
        KernelID.RUPAY.toByte() -> {
            tlvList = StringBuilder()
                ...
                .append("9F3303E068C8")// Terminal capabilities
                .append("9F350122") // Terminal type
...
/*//region =======extra demo tags start =========
                ...
                .append("DF814002002C")//R_TAG_TM_SRTRANS_CAP
                .append("DF16020015")
 ...
 //endregion ========= extra demo tags End*/
                ...
                .append("9F09020002")//EMV_TAG_TM_APPVERNO


                // .append("9F1B0400003A98")//EMV_TAG_TM_FLOORLMT

                //   .append("DF918111050050000000") // Terminal action code(decline) -->New

                .append("DF918111050010000000")// --> old tac decline for vx9900
                ...
                .append("DF918121039F3704")

                //   Df918170,

                .append("DF812306000000000000").toString() //Terminal Contactless Floor Limit

            emv?.setTLV(finalData.kernelID.toInt(), R_TAG_TM_TRANS_LIMIT,clsMaxTransLimit)//DF4c --> Terminal Contactless Transaction Limit
            emv?.setTLV(finalData.kernelID.toInt(),R_TAG_TM_CVM_LIMIT,clsCvmLimit)//DF4D --> Terminal CVM Required Limit
            emv?.setTLV(finalData.kernelID.toInt(),DEF_TAG_M_REQ_NOCVM,"08")
...
println("SELECTED KERNAL ID ------->  ${finalData.kernelID.toInt()}")
    val selcetedCapKeyIndex = emv?.getTLV(Integer.toHexString(0x8F))
    val selcetedAid_9F06 = emv?.getTLV(Integer.toHexString(0x9F06))
    val selcetedAid_84 = emv?.getTLV(Integer.toHexString(0x84))

    println("CARD CAP KEY --> ${selcetedCapKeyIndex} , CARD AID -->${selcetedAid_9F06} , ${selcetedAid_84}")
