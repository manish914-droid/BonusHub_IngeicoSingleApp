...
class ReportsFragment : Fragment(), IReportsFragmentItemClick {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        refreshSubToolbarLogos(
            ...
            getString(R.string.reports_header)
        )
                ...
                if (batchData != null) {
                    ...
                    when (batchData.transactionType) {
                        ...
                        BhTransactionType.TEST_EMI.type -> {
                            ...
                            PrintVectorUtil(requireContext()).startPrinting(
                                batchData,
                ...
                if (isoW != null) {
                    ...
                    iDiag?.alertBoxWithActionNew(
                        ...
                        "No", true, true,
                        {
                            ...
                            try {
                                PrintVectorUtil(context).printReversal(
                                    context,
                                    AppPreference.getString(AppPreference.FIELD_60_DATA_REVERSAL_KEY)
                                ) {
            ...
            ReportsItem.ANY_RECEIPT -> {
                ...
                DialogUtilsNew1.getInputDialog(
                    ...
                    { invoice ->
                        ...
                        lifecycleScope.launch(Dispatchers.Main) { // here create a co-routine because getTempBatchTableDataListByInvoice is suspend and Dispatchers.Main because we are observe.
                            try {
...
// End of Any Receipt case
            ...
            ReportsItem.DETAIL_REPORT -> {
                ...
                settlementViewModel?.getTempBatchFileData()
                    ?.observe(viewLifecycleOwner) { batchData ->
                        ...
                        if (batchData.isNotEmpty()  /*&& onlyPreAuthFlag == false*/) {
                            ...
                            iDiag?.alertBoxWithActionNew(
                                ...
                                getString(R.string.no), true, true,
                                {

                                    if (batchData.isNotEmpty()) {
                                        try {
                                            lifecycleScope.launch(Dispatchers.Main) {  // here create co-routine because without co-routine not show dialog progress
...
// End of Detail report
            ...
            ReportsItem.SUMMERY_REPORT -> {
                ...
                settlementViewModel?.getTempBatchFileData()
                    ?.observe(viewLifecycleOwner) { batList ->
                    ...
                    iDiag?.alertBoxWithActionNew(
                        ...
                        "No", true, true,
                        {
                            ...
                            try {
                                ...
                                PrintVectorUtil(activity).printSettlementReportupdate(
                                    activity,
                                    batList as MutableList<TempBatchFileDataTable>,
                                    false,
                                    true
                                ) {
                                    iDiag?.hideProgress()
