...
import com.bonushub.crdb.india.utils.Field48ResponseTimestamp.deletePreAuthByInvoice
import com.bonushub.crdb.india.utils.Field48ResponseTimestamp.getBatchDataByInvoice
import com.bonushub.crdb.india.utils.Field48ResponseTimestamp.getPreAuthByInvoice
...
import com.bonushub.crdb.india.utils.ingenico.RawStripe
...
import com.bonushub.crdb.india.viewmodel.viewModelFactory.BrandEmiByCodeVMFactory
            ...
            if (resultCode == RESULT_OK) {
                ...
                try {
                    ...
                    if (globalCardProcessedModel.getReadCardType() == DetectCardType.MAG_CARD_TYPE) {
                        ...
                        cardCaptureType =
                            if (globalCardProcessedModel.getFallbackType() == com.bonushub.crdb.india.utils.EFallbackCode.EMV_fallback.fallBackCode) {
