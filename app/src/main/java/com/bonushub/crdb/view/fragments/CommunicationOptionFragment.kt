...
class CommunicationOptionFragment : Fragment(), ICommunicationOptionFragmentItemClick, IBankFunctionsTableEditItemClick {
    ...
    fun setUiForEdit()
    {
        when(type){
            ...
            CommunicationParamItem.TXN_PARAM -> {
                ...
                lifecycleScope.launch(Dispatchers.Main) {
                    bankFunctionsViewModel.getTerminalCommunicationTableByRecordType("1")?.observe(viewLifecycleOwner,{
            ...
            CommunicationParamItem.APP_UPDATE_PARAM -> {
                ...
                lifecycleScope.launch(Dispatchers.Main) {
                    bankFunctionsViewModel.getTerminalCommunicationTableByRecordType("2")?.observe(viewLifecycleOwner,{
