package com.bonushub.crdb.view.base.emv;
...
import com.bonushub.crdb.view.base.BaseDeviceActivity;
...
public abstract class BaseEMVActivity extends BaseDeviceActivity {
	...
	protected void respondAID(byte[] aid) {
		try {
			...
			TLV tmAid = com.bonushub.crdb.utils.ingenico.TLV.fromData(EMVTag.EMV_TAG_TM_AID, aid);
